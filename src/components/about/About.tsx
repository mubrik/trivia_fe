...
import {List, ListItem, ListItemText, useMediaQuery, useTheme, Stack} from '@mui/material';
  ...
  return (
    <>
      <List dense={true}>
        ...
        <ListItem>
          <ListItemText secondary={'Whoosh'}>
            {' '}
            I wield great powers so make sure to come back often to see it in use ... and maybe play a game or 2{' '}
          </ListItemText>
        </ListItem>
        <ListItem>
          <Stack direction={'row'} spacing={2}>
            <motion.div variants={animeButtonVariants} whileHover={'hover'}>
              <SocialIcon
                bgColor={colorMode === 'light' ? 'black' : '#00b2ffc4'}
                url={'https://github.com/mubrik'}
                title={'Github'}
              />
            </motion.div>
            <motion.div variants={animeButtonVariants} whileHover={'hover'}>
              <SocialIcon url={'mailto:mubarakg4u@gmail.com'} network={'email'} title={'Email'} />
            </motion.div>
            <motion.div variants={animeButtonVariants} whileHover={'hover'}>
              <SocialIcon url={'https://t.me/mubrik1'} network={'telegram'} title={'Telegram'} />
            </motion.div>
            <motion.div variants={animeButtonVariants} whileHover={'hover'}>
              <SocialIcon url={'https://www.linkedin.com/in/mubarakyahaya'} title={'LinkedIn'} />
            </motion.div>
          </Stack>
        </ListItem>
      </List>
  ...
  return (
    <>
      <List dense={true}>
        ...
        <ListItem>
          <ListItemText secondary={'https://www.vecteezy.com/free-vector/abstract/'}>
            {' '}
            Wallpapers by Vecteezy{' '}
          </ListItemText>
        </ListItem>
      </List>
    </>
